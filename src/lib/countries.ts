...
/**
 * ISO 3166-1 country list (canonical short names) used by the wizard's
 * nationality picker. Stable, public list — names match those used by
 * Home Affairs publications where practical.
 */
export const COUNTRIES: ReadonlyArray<Country> = [
  ...
  { name: "São Tomé and Príncipe", alpha2: "ST" },
...
for (const c of COUNTRIES) {
  ...
  COUNTRY_LOOKUP.set(c.alpha2.toLowerCase(), c);
}
